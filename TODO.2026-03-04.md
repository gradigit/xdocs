...
- **Dependencies**: none
- **Files in scope**: `tests/golden_qa.jsonl`, `src/cex_api_docs/validate.py`
...
- **Steps**:
  1. Add prefix-match and domain-match metrics to validate.py
     ...
     - Artifacts: `src/cex_api_docs/validate.py`
...
- **Files in scope**: `src/cex_api_docs/semantic.py`, `src/cex_api_docs/chunker.py`, `src/cex_api_docs/embeddings.py`
...
- **Steps**:
  ...
  2. Fix chunking to preserve page-level context (heading hierarchy in chunk text)
     ...
     - Artifacts: `src/cex_api_docs/chunker.py`
  3. Tune hybrid search (FTS5 weight, top-K candidates, rerank parameters)
     ...
     - Artifacts: `src/cex_api_docs/semantic.py`
...
- **Files in scope**: `src/cex_api_docs/embeddings.py`, `src/cex_api_docs/semantic.py`, CLAUDE.md, AGENTS.md
...
- **Steps**:
  1. Update embedder defaults to 0.6B model, batch_size to 128
     ...
     - Artifacts: `src/cex_api_docs/embeddings.py`, `src/cex_api_docs/semantic.py`
