...
## Key Decisions
- Greenfield build: treat `docs/archive/cex-api-docs-plan-handoff/` as reference-only design notes/pseudocode.
...
- Prior-art research, gap analysis, and challenge passes completed; prompt ready at `docs/archive/architect/prompt.md`.
