...
- Inventory enumeration uses sitemaps when available; sections with low inventory URL counts likely need explicit `doc_sources` additions or browser-assisted ingestion (`ingest-page`).
